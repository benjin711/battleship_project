...
private:
     ...
     */
    std::vector<std::pair<int, int> > akttmpVector;
    /**
...
public slots:
     ...
     */
    void setShip( std::vector<std::pair<int, int>>ship);
    /**
     ...
     */
    void endposition(std::vector<std::pair<int, int>>tmpVector, std::pair<int, int>pos, int numbship);
    /**
     ...
     */
    void randomPositions(std::vector<std::pair<int, int> >vector);
